    ...
    >
        ...
        <div>
            ...
            <x-text-input
                ...
                class="mt-4 block w-full border text-sm file:mr-4 file:border-0 file:bg-teal-200 file:px-4 file:py-2 file:text-xs file:font-semibold file:tracking-widest file:text-pink-700 file:transition-colors hover:file:bg-teal-100 focus:outline-none focus:ring-0"
            />
